...
import type { AutoFollowSnapshot } from "../auto-follow/autoFollow";
...
export function autoFollowSnapshot(overrides: Partial<AutoFollowSnapshot> = {}): AutoFollowSnapshot { return { documentToken: autoFollowDocument, sourceToken: "/one.mp3", enabled: true, playing: true, currentLineId: "line-1", playbackPosition: 10, mode: "unpinned", followRequest: 0, ...overrides }; }
