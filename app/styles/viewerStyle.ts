...
export const viewerStyle: ViewerStyle = {
  ...
  text: {
    ...
    languageSwitch: "rounded bg-amber-50 px-1 text-amber-950 ring-1 ring-amber-200",
    languageBadge:
      "ml-2 mr-2 inline-flex items-center rounded border border-amber-300 bg-amber-50 px-1.5 py-0.5 align-middle text-xs font-semibold text-amber-900",
